...
export class Backend implements backendInterface {
    ...
    async calculatePersonalityType(arg0: Array<bigint>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.calculatePersonalityType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPersonalityTypeByCode(arg0: string): Promise<PersonalityType> {
        if (this.processError) {
            try {
